...
while($guideToPrint=mysqli_fetch_array($directory_query)) {
	...
	if ($guideToPrint['email']=="") {
		$emailStr = "<em style=\"color:#BBBBBB\">email not provided</em>";
	} else {
		$emailStr = "<a href = \"mailto:".$guideToPrint['email']."\">".$guideToPrint['email']."</a>";
	}
	
	$phoneStr = "(".$guideToPrint['school_phone_1'].")-".$guideToPrint['school_phone_2']."-".$guideToPrint['school_phone_3'];
	if ($phoneStr=="(000)-000-0000" || $phoneStr=="()--") {
		$phoneStr = "<em style=\"color:#BBBBBB\">phone not provided</em>";
	} else {
		$phoneStr = "<a href=\"tel:".$guideToPrint['school_phone_1'].$guideToPrint['school_phone_2'].$guideToPrint['school_phone_3']."\">".$phoneStr."</a>";
	}
	...
	$row = "<tr>
			<td style=\"vertical-align:middle\"><h4 style=\"margin:0px\"><a href=\"guide.php?id=".$guideToPrint['guide_id']."\">".$guideToPrint['firstname']." ".$guideToPrint['lastname']."</a></h4><small style=\"color:#999999\"><em>".$updateStr."</em></small></td>
			...
			<td style=\"vertical-align:middle\">".$emailStr."<br>
												".$phoneStr."</td>
			</tr>";
