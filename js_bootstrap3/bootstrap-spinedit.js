...
!function ($) {
	...
	'<span class="spinedit">' +
      ...
      '<span class="glyphicon glyphicon-chevron-up" style="cursor:pointer"></span>' +
    '</span>';
	// DRPGlobal.template =
      // '<span class="glyphicon glyphicon-chevron-down" style="position: relative; top: 8px; margin-right: -5px; cursor:pointer"></span>' +
      // '<span class="glyphicon glyphicon-chevron-up" style="position: relative; top: -8px;  left: -8px; cursor:pointer"></span>';
